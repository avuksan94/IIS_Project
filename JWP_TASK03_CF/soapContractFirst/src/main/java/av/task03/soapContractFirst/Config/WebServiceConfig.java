package av.task03.soapContractFirst.Config;
...
public class WebServiceConfig extends WsConfigurerAdapter {
    ...
    public ServletRegistrationBean messageDispatcherServlet(ApplicationContext applicationContext) {
        ...
        return new ServletRegistrationBean(servlet, "/wscf/*");
    }
    @Bean(name = "workoutsCF")
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema workoutsSchema) {
        ...
        wsdl11Definition.setLocationUri("/soap-apiCF");
        wsdl11Definition.setTargetNamespace("http://avtest.com/soap-web-serviceCF");
    ...
    public XsdSchema workoutsSchema() {
        return new SimpleXsdSchema(new ClassPathResource("workouts.xsd"));
    }
}